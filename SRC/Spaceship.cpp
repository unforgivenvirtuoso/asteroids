...
void Spaceship::Shoot(void)
{
	...
	GLVector3f bullet_velocity = mVelocity + spaceship_heading * BulletSpeed;
...
void Spaceship::OnCollision(const GameObjectList &objects)
{
	for (auto object : objects) {
		if (object->GetType() == GameObjectType("Asteroid") || object->GetType() == GameObjectType("smallAsteroid") 
			|| object->GetType() == GameObjectType("Alien")) {
